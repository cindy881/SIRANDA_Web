                ...
                <table class="table v-middle table-sm" id="example">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <a class="btn btn-success btn-sm" href="{{ route('dashboard.tindaklanjut') }}"><i class="bi bi-eye" style="font-size: .75rem;"></i></a>
                            </td>
                        </tr>
                 ...
                 //add markers
                    if (pelanggarans.length) {
                        ...
                        if (lat && lng) {
                            ...
                            .bindPopup(label1 + '<br>' + label2 + '<br>' + label3 + '<br><a href="{{ url('dashboard/pelanggaran') }}">view detail</a>')
                            .addTo(map);
