    ...
    <div class="card-body">
        <form action="{{ url('dashboard/pelanggaran/create') }}" method="POST">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control @error('tgl_pelanggaran') is-invalid @enderror" name="tgl_pelanggaran" value="{{ old('tgl_pelanggaran') }}">
            ...
            <div class="row  mb-2">
                ...
                <div class="col-sm-10">
                    <input type="file" class="form-control @error('filefoto_pelanggaran') is-invalid @enderror" name="filefoto_pelanggaran" value="{{ old('filefoto_pelanggaran') }}">
            ...
            <div class="row  mb-2">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control @error('lat_pelanggaran') is-invalid @enderror" name="lat_pelanggaran" value="{{ old('lat_pelanggaran') }}" placeholder="Latitude">
                    @error('lat_pelanggaran')
                    <div class="invalid-feedback">{{$message}}</div>
                    @enderror
                </div>
                <div class="col-sm-5">
                    <input type="text" class="form-control @error('lng_pelanggaran') is-invalid @enderror" name="lng_pelanggaran" value="{{ old('lng_pelanggaran') }}" placeholder="Longitude">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('bentuk_pelanggaran') is-invalid @enderror" name="bentuk_pelanggaran" value="{{ old('bentuk_pelanggaran') }}">
